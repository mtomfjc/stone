...
@Reviser public class ClassEvaluator {
	...
	@Reviser public static class DotEx extends Dot{
		...
		public Object eval(Environment env, Object value){
			...
			throw new StoneException("bad number access: " + member, this);
		}
			...
			if(le instanceof PrimaryExpr){
				...
				if(p.hasPostfix(0) && p.postfix(0) instanceof Dot){
					...
					if(t instanceof StoneObject){
						return setFeild((StoneObject)t, (Dot)p.postfix(0), rvalue);
					}
				}
			}
			return super.computeAssign(env, rvalue);
		}
		protected Object setFeild(StoneObject obj, Dot expr, Object rvalue){
